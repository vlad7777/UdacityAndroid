package com.example.root.sunglitter.sync;
...
import com.example.root.sunglitter.ForecastFragment;
import com.example.root.sunglitter.MainActivity;
import com.example.root.sunglitter.R;
import com.example.root.sunglitter.Utility;
...
import static com.example.root.sunglitter.Utility.areNotificationsEnabled;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWeather() {
        Log.i(LOG_TAG, "notifyWeather called");
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String appidValue = "de27fcaf8f0a1b9314c78b94523e93c9";
            ...
            Log.i(LOG_TAG, "connected, downloading");
    ...
    private void deleteOldData() {
        ...
        getContext().getContentResolver().delete(WeatherContract.WeatherEntry.buildWeatherDeleteWithEndDate(yesterday), null, null);
    }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[]{WeatherContract.LocationEntry._ID}, selection, selectionArgs, null, null);
        long id = -1;
        if (cursor.moveToFirst()) {
            Log.i(LOG_TAG, "Found the " + locationSetting);
            id = cursor.getLong(0);
            Log.i(LOG_TAG, "" + id);
            cursor.close();
            return id;
            ...
            Log.i(LOG_TAG, "Want to insert a new location");
            Log.i(LOG_TAG, cv.toString());
    ...
    public static Account getSyncAccount(Context context) {
        Log.d(LOG_TAG, "getSyncAccount called");
